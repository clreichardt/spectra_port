...
if __name__ == '__main__':
    ...
    final_bands = np.asarray([0,500,1000,1500,2000,
                              2200,2500,2800,3100,3500,
                              3900,4400,4900,5500,6200,
                              7000,7800,8800,9800,11000,
                              12000])
    nfb = len(final_bands)-1

    i0 = np.ones(nfcombo,dtype=np.int32)*4
    i1 = np.ones(nfcombo,dtype=np.int32)*19 #11000
